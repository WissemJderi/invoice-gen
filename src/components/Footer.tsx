...
const Footer = () => {
  ...
  return (
    <div className="xl:mx-60 mx-3 lg:mt-30 lg:mb-10 mt-20 mb-5  sm:mt-20 border-t-2 border-black/40 p-2">
      <h2 className="font-light text-2xl text-white text-center">
        InvoiceGen <span className="text-gray-400 text-sm">v1.0.0</span>
      </h2>
      <p className="text-gray-300 lg:text-lg text-xs mx-2 my-2 text-center">
      ...
      <div className="flex flex-row lg:text-sm text-xs justify-around text-gray-300 my-1">
